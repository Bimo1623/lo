// --- 1. COUNTDOWN LOGIC (Lengkap dengan Detik) ---
// (Logika Countdown dipindahkan ke script surprise.js agar terintegrasi dengan efek kembang api)
...
if(ctaBtn) {
    ctaBtn.onclick = () => navigateTo('wish.html');
}
